    ...
    <div class="out-wrap">
      <div
        ...
        <layout :style="{padding: '0 15px',background: '#fff',height: '100%'}">
            ...
            <div class="all-btn">
              <button
                ...
                <span style="fontSize:0">
                  ...
                  <span
                    class="btn-title"
                    style="padding:0;fontSize:12px;verticalAlign: middle;">新 建</span>
                </span>
              </button>
              <button
                type="button"
          ...
          <create-rule
            :modal10="modal10"
            @changeValue="change"></create-rule>
          <i-modal
            title="信息确认"
            v-model="offRuleSet"
              ...
              <div
                ...
                <h3 class="pr">
                  <img
                    ...
                    alt=""
                    class="delete-img pa">
                  <span class="pa">是否确认删除选中的规则{{BatchRuleSet?"(&nbsp;数量&nbsp;:&nbsp;"+56+"&nbsp;个)":""}}</span>
                </h3>
              </div>
            </div>
            <div slot="footer">
...
<script>
import CreateRule from "./CreateRule.vue"; //新建规则集
export default {
  mounted() {
    this.resPage(1);
  },
